...
interface SupplierAddModalProps {
  onClose: () => void;
  onSave: (newSupplierData: Omit<Supplier, 'id'>) => void;
}

const SupplierAddModal: React.FC<SupplierAddModalProps> = ({ onClose, onSave }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-lg m-4 transform transition-all">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">Cadastrar Novo Fornecedor</h2>
